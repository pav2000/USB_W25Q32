...
#define TFT_DC_C()	ST7735_DC_GPIO_Port -> BRR 	= ST7735_DC_Pin // команда Низкий
...
//	HAL_GPIO_WritePin(GPIOA, ST7735_CS_Pin, GPIO_PIN_SET);
...
void ST7735_Init()
{
	...
	TFT_CS_L();
    ST7735_Reset();
    HAL_Delay(20); // pav2000 Пауза 20 миллисекунд дисплей должен проинициализироваться
